...
Menu::Menu() : _window(sf::VideoMode(1920, 1080), "JetPack Menu", sf::Style::Default),
    ...
    _tittle("Olympic", "assets/Fonts/earwig factory rg.otf", sf::Color::White, 630, 10, sf::Vector2f(1.2, 1.2)),
    _tittle2("Jet", "assets/Fonts/earwig factory rg.otf", sf::Color::White, 810, 180, sf::Vector2f(1.0, 1.0)),
